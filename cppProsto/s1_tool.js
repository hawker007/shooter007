...
module.exports =
{
  memory_init : function()
  {
    ...
    if(Game.spawns.s1.memory.memoryReinit == true)
    {
      ...
      Game.spawns.s1.memory.RoomID = "W37N3";
      
      Game.spawns.s1.memory.energyID_0 = "5bbcaaf29099fc012e6327ca";
      Game.spawns.s1.memory.energyID_0_pos = [];
      Game.spawns.s1.memory.energyID_0_pos[0] = 6; // x
      Game.spawns.s1.memory.energyID_0_pos[1] = 23; // y
      Game.spawns.s1.memory.energyID_0_max_creeps = 4;
      Game.spawns.s1.memory.energyID_0_wait_pos = [];
      Game.spawns.s1.memory.energyID_0_wait_pos[0] = 10; // x
      Game.spawns.s1.memory.energyID_0_wait_pos[1] = 22; // y
      Game.spawns.s1.memory.energyID_0_gath_count = 0;

      Game.spawns.s1.memory.energyID_1 = "5bbcaaf29099fc012e6327c9";
      Game.spawns.s1.memory.energyID_1_pos = [];
      Game.spawns.s1.memory.energyID_1_pos[0] = 37; // x
      Game.spawns.s1.memory.energyID_1_pos[1] = 18; // y
      Game.spawns.s1.memory.energyID_1_max_creeps  = 1;
      Game.spawns.s1.memory.energyID_1_wait_pos    = [];
      Game.spawns.s1.memory.energyID_1_wait_pos[0] = 37; // x
      Game.spawns.s1.memory.energyID_1_wait_pos[1] = 13; // y
      ...
      Game.spawns.s1.memory.mineralMineID = "5bbcb1a240062e4259e9316e";
