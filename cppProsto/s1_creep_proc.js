...
module.exports =
{
  ...
  processing : function()
  {
    ...
    console.log('builder_count       ',Game.spawns.s1.memory.harvester_count);
    console.log('rcl_upgrader_count  ',Game.spawns.s1.memory.rcl_upgrader_count);
    console.log('builder_count       ',Game.spawns.s1.memory.builder_count);
